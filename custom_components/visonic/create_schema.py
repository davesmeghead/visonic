...
FormItems: Final[dict[str, list[str]]] = {
    ...
    FORM_PARAM13: [CONF_LOG_EVENT, CONF_LOG_DONE, CONF_LOG_REVERSE, CONF_LOG_CSV_TITLE, CONF_LOG_XML_FN, CONF_LOG_CSV_FN, CONF_LOG_MAX_ENTRIES, CONF_IMAGE_MEDIA_PATH],
